...
Transformation Matrix from CL** to CL***

RMSE: 2.11122 mm
|        |        |        |        |
|--------|--------|--------|--------|
| 0.8733 | 0.1979 | -0.4452 | 417.038 |
| -0.0942 | 0.9651 | 0.2442 | 153.809 |
| 0.4780 | -0.1713 | 0.8615 | 317.092 |
| 0      | 0      | 0      | 1      |

> 위 행렬은 변환 행렬(Transformation Matrix)의 예시입니다. (소수점 4자리 반올림)
...
### 캘리브레이션 프로세스
![usage_img](./img/usage_example.jpeg)
...
![calibration_image](./img/calibration_capture.jpeg)
